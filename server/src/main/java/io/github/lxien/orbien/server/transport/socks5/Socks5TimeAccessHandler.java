...
public class Socks5TimeAccessHandler extends TimeAccessHandler {
    @Autowired
    private ProxyConfigService proxyConfigService;

    @Autowired
    public Socks5TimeAccessHandler(TimeAccessChecker timeAccessChecker, StreamManager streamManager) {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        ProxyConfigExt ext = proxyConfigService.findByListenPort(getListenerPort(visitor), ProtocolType.SOCKS5);
