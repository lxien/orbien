...
/** ACME DNS 挑战：1=待验证 2=传播中 3=已验证 4=失败 5=已清理 */
export function resolveAcmeChallengeStatusTagType(status?: number): AcmeOrderStatusTagType {
...
/** @deprecated 使用 resolveAcmeChallengeStatusTagType */
