...
//
//        Message.Proxy config = event.getProxy();
...
//    }
//
//    private void handleStandaloneAgent(ProxyAddEvent event, Message.Proxy config) {
...
//            DomainType domainType = domains.getFirst().getDomainType();
//
