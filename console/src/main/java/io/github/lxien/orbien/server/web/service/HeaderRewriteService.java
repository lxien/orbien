...
public interface HeaderRewriteService {
    HeaderRewriteDetailDTO getByProxyId(String proxyId);

    void update(HeaderRewriteUpdateParam param);

    void addRule(HeaderRewriteRuleAddParam param);

    void updateRule(HeaderRewriteRuleUpdateParam param);
